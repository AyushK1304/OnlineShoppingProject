...
public class DAO {
	...
	public static Connection getCon() {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ospjsp", "root", "BMWM4Compitition");
	...
	public static Vector validate() {
		...
		try {
			...
			jrs.setUrl("jdbc:mysql://localhost:3306/ospjsp");
			jrs.setUsername("root");
			jrs.setPassword("BMWM4Compitition");
